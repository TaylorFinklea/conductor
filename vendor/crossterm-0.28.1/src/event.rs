...
/// won't block.
///
/// Returns an error with [`io::ErrorKind::UnexpectedEof`](std::io::ErrorKind::UnexpectedEof)
/// if the input reaches end of file because the terminal went away or redirected input ended.
///
/// # Arguments
///
