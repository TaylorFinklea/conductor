    ...
    fn run_handle(temp: &TempDir, label: &str) -> RunHandle {
        RunHandle::create(
            ...
            crate::run::NewRun {
                ...
                work: Some(crate::run::WorkState { cycle_id: "cycle-1".to_string(),
    ...
    fn manifest_for(
        ...
        let mut handle = RunHandle::create_at(
            ...
            crate::run::NewRun {
                ...
                limits: crate::run::RunLimits::default(),
                verifier: crate::run::RunVerifier::default(),
                work: Some(crate::run::WorkState { cycle_id: "cycle-legacy".to_string(),
                authorization_sha256: "a".repeat(64),
    ...
    fn running_manifest_for(
        ...
        let mut handle = RunHandle::create_at(
            ...
            crate::run::NewRun {
                ...
                limits: crate::run::RunLimits::default(),
                verifier: crate::run::RunVerifier::default(),
                work: Some(crate::run::WorkState { cycle_id: "cycle-running".to_string(),
                authorization_sha256: "a".repeat(64),
